...
RSpec.feature "Users", type: :feature do
  ...
  scenario "user log out Books App" do
    ...
    expect(page).to have_content I18n.t(:'activerecord.attributes.user.remember_me')
    # expect(page).to have_content I18n.t(:'devise.sessions.signed_out') #出ないため検証中
  end
  ...
  scenario "user deletes own account" do
    ...
    expect{
      ...
      page.accept_confirm
      expect(page).to have_content I18n.t(:'activerecord.attributes.user.remember_me')
      # expect(page).to have_content I18n.t(:'devise.registrations.destroyed') # 出ないため検証中
